    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form name="chngpwd" class="bg-light p-5 contact-form" method="post">
                        <?php
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" name="submit6" value="Update" class="button button-contactForm boxed-btn">
                        </div>
                    </form>
                </div>
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        <p class="mb-0"><a href="change-password.php" class="btn btn-primary px-4 py-3">Change Password</a></p>
                    </div>
                    <div class="media contact-info">
                        <p class="mb-0"><a href="tour-history.php" class="btn btn-primary px-4 py-3">Tour History</a></p>
                    </div>
                </div>
            </div>
        </div>
