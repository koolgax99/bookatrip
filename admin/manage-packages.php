...
?>
	...
	<head>
		<title>TripGuru | admin manage packages</title>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td><?php echo htmlentities($result->PackageSchedule); ?></td>
												<td><?php echo htmlentities($result->PackageFlights); ?></td>
												<td><?php echo htmlentities($result->PackageHotels); ?></td>
												<td><?php echo htmlentities($result->PackageSightseeing); ?></td>
												<td><?php echo htmlentities($result->PackageMeals); ?></td>
