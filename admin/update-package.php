...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackageSchedule=:pschedule,PackageFlights=:pflights,PackageHotels=:photels,PackageSightseeing=:psightseeing,PackageMeals=:pmeals,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails,PackagePaymentPolicy=:ppaymentpolicy,PackageCancellationPolicy=:pcancellationpolicy,PackageTourIncludes=:ptourincludes, PackageTourNotIncludes=:ptournotincludes, PackageVisa=:pvisa, PackageItinerary=:pitinerary where PackageId=:pid";
									...
									foreach ($results as $result) {	?>
										...
										<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packageschedule" id="packageschedule" placeholder=" Package Schedule" value="<?php echo htmlentities($result->PackageSchedule); ?>" required>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Flights</label>
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packageflights" id="packageflights" placeholder=" Package Flights" value="<?php echo htmlentities($result->PackageFlights); ?>" required>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Hotels</label>
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packagehotels" id="packagehotels" placeholder=" Package Hotels" value="<?php echo htmlentities($result->PackageHotels); ?>" required>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Sightseeing</label>
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packagesightseeing" id="packagesightseeing" placeholder=" Package Sightseeing" value="<?php echo htmlentities($result->PackageSightseeing); ?>" required>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Meals</label>
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packagemeals" id="packagemeals" placeholder=" Package Meals" value="<?php echo htmlentities($result->PackageMeals); ?>" required>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagedetails" id="packagedetails" placeholder="Package Details" required><?php echo $result->PackageDetails; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Payment Policy</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagepaymentpolicy" id="packagepaymentpolicy" placeholder="Package Payment Policy" required><?php echo $result->PackagePaymentPolicy; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Cancellation Policy</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagecancellationpolicy" id="packagecancellationpolicy" placeholder="Package Cancellation Policy" required><?php echo $result->PackageCancellationPolicy; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Tour Prices Includes</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagetourincludes" id="packagetourincludes" placeholder="Package Tour Prices Includes" required><?php echo $result->PackageTourIncludes; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Tour Price Does not Include</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagetournotincludes" id="packagetournotincludes" placeholder="Package Tour Price Does not Includes" required><?php echo $result->PackageTourNotIncludes; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Visa, Passport and Insurance</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packagevisa" id="packagevisa" placeholder="Package Visa" required><?php echo $result->PackageVisa; ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Package Itinerary</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="packageitinerary" id="packageitinerary" placeholder="Package Itinerary" required><?php echo $result->PackageItinerary; ?></textarea>
												</div>
											</div>
											<div class="form-group">
